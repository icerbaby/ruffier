...
def test(P1, P2, P3, age):
    ...
    if age < 7:
        ...
        result_number = ruffier_result(ruff_index, neud_level(age))
        result = txt_res[result_number]  # интерпретация, перевод числового уровня подготовки в текстовые данные
